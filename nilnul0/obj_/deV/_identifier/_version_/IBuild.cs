...
namespace nilnul.obj_.deV._identifier._version_
{
	...
	/// </remarks>
	/// vs
	///		:<see cref="nilnul.dev.src.IVersion"/>, where there is no build
	///		<see cref="nilnul.dev.src._version_.IPatch"/>, where it's one of git snap which is src state at any expressible times;
