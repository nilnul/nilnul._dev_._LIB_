...
namespace nilnul.obj_.deV_.pkg._identity.version_.ms_
{
	...
	/// to use days /seconds, not date shortform like "220802", is intended for a robust comparision as shortform might introduce a leading nil.
	/// note int.max >= seconds of the day, but short.max is not. so using half of secondsOfDay might intend to reduce its width.
	/// </summary>
	///
	public class Timed
	{
