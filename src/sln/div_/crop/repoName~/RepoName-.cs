...
{
	[Obsolete(nameof(nilnul.dev.src.sln.div._RepoNameX))]
	public class RepoName1
	{
		...
		public RepoName1(SrcsI3 srcs)
		{
			_srcs = srcs;
		}

		public RepoName1():this(
		...
		public RepoName1(StringCollection srcs1):this(
		...
		public RepoName1(IEnumerable<Shield> enumerable):this(  Srcs3.FroUnsured(enumerable))
		{

		}

		public RepoName1(Disjoint disjoint1):this(new Srcs3(disjoint1) as SrcsI3)
		{
		}
		...
		public string getName(nilnul.fs.address_.ShieldI container) {
			...
			return string.Join(".",
				dirs.Select(
					d =>nilnul.fs.folder._repoName.dir.name_.idioms0Comments._ParseX.Parse(
						d.denote.ToString()
					).name
				).Select(
		...
		static public RepoName1 Singleton
		{
			get
			{
				return nilnul.Singleton1<RepoName1>.Instance;
			}
		}
