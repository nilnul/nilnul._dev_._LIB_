...
namespace nilnul.dev.src.sln.sub.prj.meta.of_.doc_.commented_
{
	/// <summary>
	...
	static public class _FroManyX
	{
		...
		)
		{
			...
			nomina = dev.src.sln._nomina.Updates.Defaulted.rewritePrj(nomina);
			...
			foreach (var prjAsShield in prjAsShieldS)
			{
				...
				//	ext
				//);
				var prjMainFound = nilnul.dev.src.sln.sub.prj.meta.nuly.of_.doc_._LocateNulableX.ChooseMain(
									prjAsShield
									,
