...
{
	static public class _FourDotEightDotOneX
	{
		static public bool _Updated_assumePrj(string file)
		{

			return  _EnsureX.Updated_fileAssumePrj(file, _target._ValX.FourDotEightDotOne);

		}
		public static void Modify(Modify prjModify)
		{
			_EnsureX.Modify(prjModify, _target._ValX.FourDotEightDotOne);
		}
