...
namespace nilnul.dev.raw_.folder_.nonlink_.giT_.nonrepo.sln_.nonlink.prj_
{
	static public class _NonlinksX
	{
		static public IEnumerable<nilnul.fs._address.Directory> Nonlinks(
			...
			)
			{
				...
				{
					foreach (var item in
nilnul.dev.raw_.folder_.nonlink_.giT_.nonrepo.sln_.nonlink.directory_.nonlink_.nonprj.directory_.nonlink_._PrjsX._Prjs_assumeSlnDirectoryNonlinkNonprj(dirShield)
						)
					{
