...
namespace nilnul.dev.raw.sln.sub.prj.meta_
{
	/// <summary>
	/// choose the project file according to identy(nomina and version)
	/// </summary>
	///
	[Obsolete(nameof(sub.synd._prj._LocateX))]
	static public class _ChoosePrjX
	{
		...
		public static (fs._address.doc_._exted.Main, fs.folder._repoName.dir.name_.idioms0Comments_.Segs) ChooseMain(nilnul.fs.address_.ShieldI prjFolderParent, string prjName, string ext)
		{
			return ChooseMain(
