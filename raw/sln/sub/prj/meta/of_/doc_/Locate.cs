...
namespace nilnul.dev.raw.sln.sub.synd._prj
{
	/// <summary>
	...
	static public class _LocateX
	{
		...
		/// <returns></returns>
		static public (fs._address.doc_._exted.Main, fs.folder._repoName.dir.name_.idioms0Comments_.Segs) ByMain(
		...
		static public (fs._address.doc_._exted.Main, fs.folder._repoName.dir.name_.idioms0Comments_.Segs) ByMain(nilnul.fs.address_.ShieldI folder, string[] prjIdentity, string ext)
		{
			return ByMain(
		...
		public static (fs._address.doc_._exted.Main, fs.folder._repoName.dir.name_.idioms0Comments_.Segs) ByMain(nilnul.fs.address_.ShieldI prjFolderParent, string prjName, string ext)
		{
			return ByMain(
		...
		public static nilnul.fs.address_.spear_.ParentDoc SpearNulable_ofDoc(string main, nilnul.fs._address.doc_._exted.Ext ext)
		{
			...
			var prjMainFound = nilnul.dev.raw.sln.sub.synd.prj._main._LocateNulableX.ChooseMain(
				prjAsShield
				,
				main
				,
		...
		public static nilnul.fs.address_.spear_.ParentDoc Spear_ofDoc(
			string main, nilnul.fs._address.doc_._exted.Ext ext, Srcs_addresses srcs)
		{
			...
			var prjMainFound = nilnul.dev.raw.sln.sub.prj.meta_._ChoosePrjX.ChooseMain(
				prjAsShield
				,
				main
				,
