...
namespace nilnul.dev.raw.sln.sub.dir_._synd
{
	/// <summary>
	...
	///<seealso cref="nilnul.dev.raws.prj._locator._SubDirX"/>
	static public class _ChooseX
	{
		...
		{
			var sub = nilnul.dev.raw.sln._sub._NulableOvPrjX._Sub_ofMain(
				prjMain,
			...
			var dnt = nilnul.dev.raw.sln.sub.dir_._synd._ChooseX.DntNulable(
				sub
				,
		...
		public  static nilnul.fs.address_.shield_.BaseDir ShieldNulable_ovBase(string main, Srcs_addresses srcs)
		{
			...
			var sub = nilnul.dev.raw.sln.div_._sub._OvPrjX._Sub_ofMain(
				main,
				srcs,
				out IEnumerable<string> subRemained
				,
