...
namespace nilnul.dev.raw.prj_.cs.be_
{
	/// <summary>
	/// lib 0 ctr
	/// </summary>
		...
		BeI
	{
		...
		static public sln.prj._name._tgt.primitive.Aliases txts {
			get {
				return nilnul.dev.raw.sln.prj._name._tgt.primitive.alias._SortieX.LIB0CTR_asAlias;
			}
		}
		...
		static public bool Be_ofTarget(string target) {
			...
			return nilnul.dev.raw.sln.prj._name._tgt.primitive.alias._SortieX.LIB0CTR_asAlias.contain(target);
		}
...
//					)
			...
			if (nilnul.dev.raw.sln.prj._name._tgt.primitive.alias._SortieX.LIB0CTR_asAlias.contain(name))
			{
				return true;
			}
			return false;
