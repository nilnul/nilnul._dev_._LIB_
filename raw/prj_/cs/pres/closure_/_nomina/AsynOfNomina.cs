...
namespace nilnul.dev.raw.prj_.cs.pres.closure_._nomina
{
	/// <summary>
	...
	static public class _AsynX
	{
		...
		)
		{
			...
			var identity = dev.raw.sln.sub.synd.prj._NominaX.Nomina(parentDoc);
		...
		)
		{
			...
			var prjMeta= nilnul.dev.raw.sln.sub.synd.prj_.cs._meta._LocateX.SpearNulable_ofMain(
			...
			/// 
			dev.raw.prj_.cs.pre_.dlls._RenameX.Changed_assumeCsPrj(prjMeta, dev.raw.sln._nomina.Updates.Defaulted);
