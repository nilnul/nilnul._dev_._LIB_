...
namespace nilnul.dev.raw.prj_.cs.build_.config_
{
	/// <summary>
	...
	public class Max
	{
		...
		public string prjNomina
		{
			...
			{
				_prjNomina = value;
				_prjFile = nilnul.dev.raw.sln.sub.synd.prj_.cs._meta._LocateX.SpearNulable_ofMain(prjNomina);
			}
		}
		...
		{
			var prjFile = this.prjFile;// nilnul.dev.raw.sln.sub.synd.prj_.cs._meta._LocateX.SpearNulable_ofMain(prjNomina);
