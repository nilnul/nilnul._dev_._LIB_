...
namespace nilnul.dev.raw.prj_.cs.pre_.dlls
{
	static public class _VwX
	{
		...
		static public IEnumerable<XElement> Els(nilnul.dev.raw.prj_.Cs file)
		{
		...
		static public IEnumerable<XElement> Els_assumeIdenty(string file)
		{
			...
			return Els_assumeCsPrj(
				nilnul.dev.raw.sln.sub.synd.prj_.cs._meta._LocateX.SpearNulable_ofMain(file)
			);
		...
		{
			return Versioneds_verPerPath(
				nilnul.dev.raw.sln.sub.synd.prj_.cs._meta._LocateX.SpearNulable_ofMain(document)
			);
		}
