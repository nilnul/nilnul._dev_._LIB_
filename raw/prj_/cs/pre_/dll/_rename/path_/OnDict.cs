...
namespace nilnul.dev.raw.prj_.cs.pre_.dll._rename.path_
{
	/// <summary>
	/// change the {HintPath} of a dll reference, according preset table of renamings.
	/// </summary>
	static public class _OnDictX
	{
		...
		static public void Vod(nilnul.dev.raw.prj_.Cs file, string refered)
		{
		...
		static public bool Modified(XDocument doc, string refered)
		{
			...
			t.Each(x =>
			{
				...
				dev.raw.sln._nomina.Updates.Defaulted.Each(
					kv =>
					{
		...
		public static void ChangePath(Modify prjModify, string setDiscrete)
		{
			prjModify.changedTouch(
				Modified(
					prjModify.xdoc
					,
					setDiscrete
