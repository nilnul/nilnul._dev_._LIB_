...
namespace nilnul.dev.raw.prj_.cs.pre_.dll
{
	static public class _RenameX
	{
		...
		static public bool Changed(nilnul.dev.raw.prj_.Cs file, string identity, string newIdentity)
		{
		...
		public static void Rename(nilnul.dev.prj_.cs.Modify file, string installed, string newIdentity)
		{
			file.changedTouch(
				Changed(file.xdoc,installed,newIdentity)
			);
		}
	}
}
