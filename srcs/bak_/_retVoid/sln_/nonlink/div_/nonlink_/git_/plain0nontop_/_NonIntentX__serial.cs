			...
			//{
				...
				try
				{
						...
						_location__nonrootWork))
					{
						...
						{
							nilnul.dev.srcs.bak_._retVoid.sln_.nonlink.directory_.nonlink_.git_.work_._TopX__serial._Exe(child, cancel, git);
						}
						else
						{
							directory_.nonlink_.git_.work_._NontopX__serial._Exe(child, cancel, git);
						}
